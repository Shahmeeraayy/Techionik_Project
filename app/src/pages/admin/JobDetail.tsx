...
export default function JobDetailPage() {
    ...
    const handleApproveInvoice = () => {
        ...
        setJob(prev => prev ? ({
            ...
            timeline: [
                { id: Date.now().toString(), type: 'INVOICE_APPROVED', title: 'Invoice Approved', actor: 'ADMIN', timestamp: 'Just now', description: 'Approved for invoice generation.' },
                ...prev.timeline
            ]
        }) : null);
        ...
        setTimeout(() => {
            setJob(prev => prev ? ({
                ...
                timeline: [
                    { id: Date.now().toString(), type: 'INVOICE_SYNCED', title: 'Invoice Created', actor: 'SYSTEM', timestamp: 'Just now', description: 'Invoice #1021 created.' },
                    ...prev.timeline
                ],
